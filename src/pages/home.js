    ...
    return ( 
        <div>
            ...
            <Row>
                    ...
                    <Image className = "homeImage1" src={homeImage1} alt="asset"/>
              
          
                    <Image className = "homeImage2" src={homeImage2} alt="asset"/>
               
            </Row>

            <Row>
              
                <Image className = "homeImage3" src={homeImage3} alt="asset"/>
